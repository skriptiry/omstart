  ...
  return (
    <Container className="p-0 m-0 mw-100">
          ...
          <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div className="col-lg-6">
              ...
              <p className="lead">
                ...
                bitch? Ill have you know I graduated top of my class in the Navy
                Seals, and Ive been involved in numerous secret raids on
                Al-Quaeda, and I have over 300 confirmed kills. I am trained in
                gorilla warfare and Im the top sniper in the entire US armed
                forces. You are nothing to me but just another target.
              </p>
      ...
      <div className="bg-dark text-secondary px-4 py-5 text-center mb-1 countdown">
        <div className="">
          <h1 className="display-5 fw-light text-white">
            <FontAwesomeIcon icon={['fas', 'quote-left']}/>
            <span className="m-4 inline-block quote">
              Ärreet kinkerit
            </span>
      ...
      <div className="container px-4 py-5" id="custom-cards">
        <div className="px-4 pt-5 my-5 text-center border-bottom">
          <h1 className="display-4 fw-bold">
            Liput kätevästi kide.appin kautta!
          </h1>
          <div className="col-lg-6 mx-auto">
            <p className="lead mb-4">
              Lipunmyynti aukeaa klo 12.00 jne. jne. mitä tähänkin kirjottelee
            </p>
            <div className="d-grid gap-2 d-sm-flex justify-content-center mb-5">
              <TicketButton />
            </div>
          </div>
          <div className="d-none d-sm-block overflow-hidden">
